...
namespace SistemaBiblioteca.Helper
{
    public static class DataHelper
    {
        ...
        //{
        //    string strconnection = "Data Source=BATCOMPUTADOR\\SQLEXPRESS;Initial Catalog = Biblioteca;Integrated Security=True;Connect Timeout=30;Trust Server Certificate=True;Application Intent=ReadWrite";
